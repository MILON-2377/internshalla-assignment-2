...
export default function Games() {
  return (
    <div className="relative -mt-[40vh] lg:-mt-[60vh] sm:-mt-[50vh] ">
      <section className="relative mt-[25vh]">
        <div className="relative w-full h-[50vh] sm:h-[60vh] lg:h-[60vh] overflow-hidden ">
          <div className="absolute w-[150vw] -right-[8%] h-[100%] top-[17%] sm:top-[25%] lg:top-[40%]  bg-gradient-to-t to-[#eac12c] from-[#fdf181] transform -rotate-[8deg] "></div>
        </div>
        <div className=" -top-[10%] relative w-full h-[20vh] sm:h-[40vh] lg:h-[60vh] overflow-hidden  ">
